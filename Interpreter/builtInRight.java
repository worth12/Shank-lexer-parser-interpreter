...
public class builtInRight extends functionNode {
  ...
  public builtInRight(String name, List<variableNode> parameters, List<variableNode> constants_variables,
  ...
  public void execute(List<interpreterDataType> parameters){
    ...
    int limit = ((integerDataType)parameters.get(1)).getValue();
    String newString = oldString.substring(limit, oldString.length() - 1);
